...
# Backward-compatible paradigm class aliases
AlephParadigm = PositivityParadigm
BetParadigm = InformationConservationParadigm
GimelParadigm = RepairCostParadigm
DaletParadigm = SpectralParadigm
HeParadigm = LyapunovParadigm
VavParadigm = TensorCompositionParadigm
ZayinParadigm = PathSumParadigm
HetParadigm = GradientParadigm
TetParadigm = CrossRatioParadigm
YodParadigm = MDLParadigm
KafParadigm = InjectivityParadigm
LamedParadigm = LocalVisibilityParadigm
MemParadigm = GaugeEquivalenceParadigm
NunParadigm = DimensionParadigm
AyinParadigm = SeparabilityParadigm
PeParadigm = SemanticMappingParadigm
TsadiParadigm = SensorCertParadigm
KufParadigm = ConservedIndexParadigm
ReshParadigm = PartialTraceParadigm
ShinParadigm = OptimalActionParadigm
TavParadigm = FixedPointParadigm
EmetParadigm = ConsistencyParadigm
SU3Paradigm = CenterSymmetryParadigm
