...
Layer 3: Knowledge     SemanticManifold (40k concepts) + TAU graph (650k edges)
...
Requires Python 3.11+. RDKit optional (enables SMILES molecular encoding).
...
| `results/agi/manifold.json` | 39,929 concepts (persistent) |
| `results/agi/tau_graph.json` | 654k+ TAU edges (persistent) |
