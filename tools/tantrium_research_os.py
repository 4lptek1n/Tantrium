...
# src/tantrium is installed as a regular package; extend its path so that
# the root tantrium/ directory (which contains research_os/) is also visible.
import tantrium as _tantrium_pkg
_root_tantrium = str(REPO_ROOT / "tantrium")
if _root_tantrium not in _tantrium_pkg.__path__:
    _tantrium_pkg.__path__.append(_root_tantrium)
