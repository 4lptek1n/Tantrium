...
This is the first commercial core of AtlasCert/Tantrium Proof Foundry:
negative symbolic mass is covered by positive symbolic sources using exact
rational dyadic transport edges.
"""
...
from tantrium.certificates.certificate import Cell, Certificate, TransportEdge, Q
...
def solve_greedy(
    ...
    source_by_id = {c.cell_id: c for c in sources}
